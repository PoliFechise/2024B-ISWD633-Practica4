...
```
docker build -t dockerfile:1.0 Dockerfile .
```

**¿Cuántos pasos se han ejecutado?**

# Se ejecutaron 3 pasos, el primero fue para establecer el contexto de ubuntu con un contenedor, el segundo para instalar apache y el tercero para obtener los archivos de la web.

### Inspeccionar la imagen creada

# ![Inspección de Dockerfile](img/P4_InspectDockerfile.png)

**Modificar el archivo index.html para incluir su nombre y luego crear una nueva versión de la imagen anterior**

**¿Cuántos pasos se han ejecutado? ¿Observa algo diferente en la creación de la imagen?**

Se volvieron a ejecutar los 3 pasos y no se vió nada diferente.
...
```
docker run -d -p 8080:80 --name docker-dockerfile dockerfile:2.0
```
...
# Una imagen que no está vinculada con ningún contenedor. Usualmente, se crean cuando se crean contenedores y no se usan más, por eso quedan olvidadas.
